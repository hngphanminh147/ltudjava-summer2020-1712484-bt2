...
public class ProfilePanel extends JPanel implements MouseListener {
	...
	private void addComponentsToContentPane() {
		...
		panel.add(lblCurrentPassword, "cell 0 0,alignx left");
		panel.add(pfCurrentPassword, "cell 1 0,growx");
		panel.add(lblNewPassword, "cell 0 1,alignx left");
	...
	private void changePassword() {
		...
		pfNewPassword.setText("");
		pfReEnterNewPass.setText("");
		JOptionPane.showMessageDialog(this, "\u0110\u1ED5i m\u1EADt kh\u1EA9u th\u00E0nh c\u00F4ng", Constant.ALERT,
